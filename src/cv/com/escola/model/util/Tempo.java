...
public class Tempo {
    ...
    public static String toString(LocalDate data) {
        return data == null ? null : data.format(formatter("dd/MM/yyyy"));
    }
    ...
    public static void blockDataPosterior(LocalDate data, DatePicker calendarario) {
        final Callback<DatePicker, DateCell> dayCellFactory = (final DatePicker datePicker) -> new DateCell() {
            @Override
            public void updateItem(LocalDate item, boolean empty) {
    ...
    public static void blockMesAnterior(LocalDate data, DatePicker calendarario) {
        final Callback<DatePicker, DateCell> dayCellFactory = (final DatePicker datePicker) -> new DateCell() {
            @Override
            public void updateItem(LocalDate item, boolean empty) {
                super.updateItem(item, empty);
